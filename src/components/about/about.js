...
export default class About extends React.Component {
    render() {
	    ...
	    <div id="about-text">
                ...
                <p>I study human-computer interaction (HCI).   My work has won multiple paper awards at CHI and CSCW. In the past, I have also worked on designing smart home devices for multi-user environments, and have interned as a software engineer at Salesforce.</p>
